...
$LANG = array(
    ...
    'hide_quantity_help' => 'Deshabilita la columna de <i>Cantidades</i>, de este modo las Facturas parecerán más limpias al no mostrar este campo.',
    ...
    'pdf_settings' => 'Configuracion del PDF',
    ...
    'default_invoice_terms' => 'Configurar términos de Factura predefinidos',
...
<li>Hoy es el viernes, la fecha límite es el primer viernes después. La fecha de vencimiento será el próximo viernes, no hoy.</li></ul>',
    ...
    'recurring_invoice_number' => 'Número Periodico',
    'recurring_invoice_number_prefix_help' => 'Indica el prefijo a añadir al Número de Factura para las Facturas Periodicas.',
    ...
    'invalid_expiry' => 'La Fecha de Vencimiento no es valida.',
    'invalid_cvv' => 'El CVV no es válido.',
    'cost' => 'Coste',
    'create_invoice_for_sample' => 'Nota: cree una Factura para previsualizarla aqui.',
    ...
    'payment_method_verified' => 'Verificación completada con éxito',
...
Una vez que tenga los montos, vuelva a esta página de métodos de pago y haga clic en "Verificación completa" junto a la cuenta.',
    ...
    'wepay_payment_tos_agree_required' => 'Debe de estar de acuerdo con los Terminos de servicio y la Politica de Privacidad de WePay.',
...
Eso es todo, tu cuenta está verificada.<br/>',
    ...
    'created_quotes' => 'Se ha creado correctamente 5 presupuesto(s)',
    ...
    'show_accept_invoice_terms' => 'Checkbox de Términos de facturación',
    'show_accept_invoice_terms_help' => 'Requerir que el cliente confirme que acepta los términos de la factura.',
    'show_accept_quote_terms' => 'Checkbox de Terminos del presupuesto',
    ...
    'i_agree' => 'Estoy de acuerdo con los terminos',
...
<ul><li>Líneas de crédito flexibles y factoraje de facturas.</li></ul>',
    ...
    'marked_sent_invoice' => 'Factura marcada con éxito',
    'marked_sent_invoices' => 'Factura marcadas con éxito',
    ...
    'emailed_invoices' => 'Facturas enviadas con éxito',
    'emailed_quotes' => 'Presupuestos enviados con éxito',
    ...
    'industry_Construction' => 'Construccion',
    ...
    'created_payment_term' => 'Terminos de Pago creado con éxito',
    'updated_payment_term' => 'Terminos de Pago actualizado correctamente',
    'archived_payment_term' => 'Terminos de Pago archivado con éxito',
    'resend_invite' => 'Reenviar Invitación',
    'credit_created_by' => 'Crédito creado por el pago :transaction_reference',
    'created_payment_and_credit' => 'Pago y Credito creado con éxito',
    'created_payment_and_credit_emailed_client' => 'Pago y Credito creado y enviado al cliente correctamente',
    ...
    'data' => 'Datos',
    'imported_settings' => 'Configuración importada con éxito',
    'lang_Greek' => 'Griego',
    ...
    'cancel_account_help' => '63/5000 Eliminar permanentemente la cuenta junto con todos los datos y la configuración.',
    ...
    'import_complete' => 'Su importación se ha completado con éxito.',
    ...
    'archived_products' => ':count productos archivados con exito',
    ...
    'emailed_payment' => 'Pagar con éxito por correo electrónico',
    ...
    'resumed_task' => 'La tarea se reanudó con éxito',
    ...
    'updated_payment_details' => 'Se actualizaron con éxito los detalles de pago',
    ...
    'recurring_prefix' => 'Prefijo Periodico',
    'options' => 'Opciones',
    ...
    'setup_desktop_app' => 'Configura la aplicación de escritorio',
