...
<head>
    ...
    <title>{{ trans('texts.client_portal') }}</title><link href="{{ asset('ic_cloud_circle.png') }}" rel="shortcut icon" type="image/png">
    @else
    <title>{{ isset($title) ? ($title . ' | Bilio Gwych') : ('Bilio Gwych | ' . trans('texts.app_title')) }}</title>
